# Documentation Enhancement for marketplace

## Overview
Comprehensive documentation enhancement targeting #629 by @syed-ghufran-hassan.
Gap to close: 305 additions.
...
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource1
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource2
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource3
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource4
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource5
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource6
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource7
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource8
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource9
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource10
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource11
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource12
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource13
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource14
```
...
```bash
curl -H "Authorization: Bearer <token>" \
  https://api.marketplace.dev/api/v1/resource15
```
...
| `DB_NAME` | string | `marketplace` | yes | Database name |
| `DB_USER` | string | `marketplace_app` | yes | Database username |
...
| `REDIS_PREFIX` | string | `marketplace` | no | Redis key prefix |
...
cat /etc/marketplace/config.yaml
