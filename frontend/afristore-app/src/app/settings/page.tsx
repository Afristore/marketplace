            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    autoSwitchNetwork: !prev.autoSwitchNetwork,
                  }))
                }
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    showTransactionHistory: !prev.showTransactionHistory,
                  }))
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  settings.showTransactionHistory
                    ? "bg-brand-500"
                    : "bg-gray-600"
                }`}
              >
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    confirmTransactions: !prev.confirmTransactions,
                  }))
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    offerUpdates: !prev.offerUpdates,
                  }))
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    auctionEndings: !prev.auctionEndings,
                  }))
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    showProfilePublicly: !prev.showProfilePublicly,
                  }))
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <button
                ...
                onClick={() =>
                  setSettings((prev) => ({
                    ...prev,
                    shareActivityData: !prev.shareActivityData,
                  }))
                }
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
