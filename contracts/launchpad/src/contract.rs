...
impl Launchpad {
    ...
    /// Look up a single collection by its deployed address.
    ...
    /// Total number of collections ever deployed through this launchpad.
